...
"""
macro_launcher.py
Консольный лаунчер для выбора и запуска макросов
"""
...
class MacroLauncher:
    """Консольный лаунчер макросов"""
    
    def __init__(self):
        self.macros_dir = Path("data/generated_macros")
        self.executor = SimpleExecutorEnhanced()
    ...
    def run(self):
        ...
        print("🚀 Macro-Assistant Launcher")
        print("Консольный лаунчер макросов")
